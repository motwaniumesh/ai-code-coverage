...
# Auto-generated tests (2025-05-20T15:21:43.550576)
...
def test_triangle_area_using_heron():
    ...
    with pytest.raises(ValueError):
        Geometry.triangle_area_using_heron(3, 4, 8)

def test_is_right_angled_triangle():
    assert Geometry.is_right_angled_triangle(3, 4, 5) == True
    assert Geometry.is_right_angled_triangle(5, 3, 4) == True
    assert Geometry.is_right_angled_triangle(4, 5, 3) == True
