...
# Auto-generated tests (2025-05-21T14:25:26.795933)
...
def test_rectangle_area_positive_dimensions():
    assert Geometry.rectangle_area(5, 10) == 50

def test_rectangle_area_zero_dimensions():
    assert Geometry.rectangle_area(0, 10) == 0
...
def test_triangle_area_using_heron_invalid_sides():
    with pytest.raises(ValueError):
        Geometry.triangle_area_using_heron(1, 1, 10)

def test_is_right_angled_triangle_right_angle_triangle():
    assert Geometry.is_right_angled_triangle(3, 4, 5) == True

def test_is_right_angled_triangle_non_right_angle_triangle():
    assert Geometry.is_right_angled_triangle(3, 4, 6) == False

def test_is_right_angled_triangle_invalid_sides():
    with pytest.raises(ValueError):
        Geometry.is_right_angled_triangle(1, 1, 10)