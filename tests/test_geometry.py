...
# Auto-generated tests (2025-05-20T18:50:06.288182)
...
def test_rectangle_area_positive_dimensions():
    assert Geometry.rectangle_area(5, 4) == 20
...
def test_triangle_area_using_heron_all_sides_positive():
    with pytest.raises(ValueError):
...
def test_is_right_angled_triangle_non_right_triangle():
    assert Geometry.is_right_angled_triangle(3, 5, 6) is False
