...
# Auto-generated tests (2025-05-21T11:46:21.193187)
...
def test_rectangle_area():
    ...
    assert Geometry.rectangle_area(1, 1) == 1
    assert Geometry.rectangle_area(3, 2) == 6
    with pytest.raises(ValueError):
...
def test_triangle_area_using_heron():
    ...
    with pytest.raises(ValueError):
        Geometry.triangle_area_using_heron(1, 1, 5)
...
def test_is_right_angled_triangle():
    ...
    assert Geometry.is_right_angled_triangle(4, 4, 4) == False
    with pytest.raises(ValueError):
