...
# Auto-generated tests (2025-05-20T16:49:37.236460)
...
def test_is_right_angled_triangle():
    ...
    assert Geometry.is_right_angled_triangle(1, 1, (2**0.5)) == True
    assert Geometry.is_right_angled_triangle(7, 8, 10) == True
    assert Geometry.is_right_angled_triangle(1, 1, 1) == False
    with pytest.raises(ValueError):
