...
# Auto-generated tests (2025-05-20T16:57:51.820487)
...
def test_days_between_dates():
    ...
    assert DateUtils.days_between_dates(start_date, end_date) == 5
...
def test_time_until_next_holiday():
    holidays = [(1, 1), (12, 25)]
    assert DateUtils.time_until_next_holiday(holidays) == timedelta(days=132)